...
class ProductController extends Controller
{
    ...
    //             $allProducts = [];
    //             $page = 1;
    //             $perPage = 100; // max WooCommerce allows
    ...
    //                 // Cache images locally and replace URLs
    ...
    //                                 $localPath = "public/products/{$shop->id}/{$imageName}";
    ...
    //                                         Storage::disk('public')->put("products/{$shop->id}/{$imageName}", $imageContents);
    //                                     } catch (\Exception $e) {
    ...
    //                                 $image['src'] = asset("storage/products/{$shop->id}/{$imageName}");
    //                             }
    //                         }
    //                     }
    //                 }
...
//                 // Cache images in public folder and update URLs
//                 foreach ($productsPage as &$product) {
//                     if (!empty($product['images'])) {
//                         foreach ($product['images'] as &$image) {
//                             $imageUrl = $image['src'] ?? null;
...
//                                 // Replace image URL with local public URL
