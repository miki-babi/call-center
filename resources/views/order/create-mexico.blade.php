    ...
    <div>
        ...
        <div >
            <div class="container mx-auto p-6">
                ...
                <form action="{{ route('MX_order') }}" method="post" class="bg-white p-6 rounded-lg shadow-md">
                    @csrf
                    ...
                    <button type="submit"
                        class="mt-6 bg-green-500 text-white px-6 py-2 rounded-lg hover:bg-green-600">Create
                        Order</button>
                </form>
            </div>
        ...
        <script>
            ...
            function searchProduct() {
                ...
                fetch(`{{ route('MX_product.search', '') }}/${encodeURIComponent(productName)}`)
                    .then(response => {
